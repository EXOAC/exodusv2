...
const mediaItems = [
  ...
  {
    type: 'image' as const,
    url: 'https://images.unsplash.com/photo-1542751110-97427bbecf23?auto=format&fit=crop&q=80&w=2340&h=1200'
  }
];

export default function ProductPUBG() {
  ...
  return (
    <div className="min-h-screen pt-24 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ProductHero
          title="PUBG External"
          description="Take control of the battlefield with our advanced PUBG toolkit"

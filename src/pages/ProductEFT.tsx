...
const mediaItems = [
  ...
  {
    type: 'image' as const,
    url: 'https://images.unsplash.com/photo-1614294148960-9aa740632a87?auto=format&fit=crop&q=80&w=2340&h=1200'
  }
];

export default function ProductEFT() {
  ...
  return (
    <div className="min-h-screen pt-24 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ProductHero
          title="EFT External"
          description="Enhance your Escape from Tarkov experience with our premium toolkit"
